        ...
        FROM
          (
            ...
            FROM
              ...
              JOIN tb_mobileapp mobileapp ON mf.mobileapp_id = mobileapp.id --   JOIN tb_dinas_mapping_function dept ON master_mf.id_mapping_function = dept.id_mapping_function
            ...
            FROM
              ...
              JOIN tb_webapp webapp ON w_mf.id_webapp = webapp.id_webapp --   JOIN tb_dinas_mapping_function dept ON master_mf.id_mapping_function = dept.id_mapping_function
